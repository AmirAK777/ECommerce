        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <h1 class="text-2xl font-semibold mb-4">{{ __('messages.create_product') }}</h1>
                    ...
                    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="details" name="details" :value="old('details')" class="block mt-1 w-full" />

                            <x-input-label for="price">{{ __('messages.product_price') }}</x-input-label>
                            <x-text-input id="price" name="price" :value="old('price')" class="block mt-1 w-full" type="number" step="any" />
